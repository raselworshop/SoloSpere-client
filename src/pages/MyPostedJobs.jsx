...
const MyPostedJobs = () => {
  ...
  const fetchAllJobs =useCallback( async () => {
    try {
      const { data } = await axios.get(`${import.meta.env.VITE_API_URL}/user/posted-job/${user?.email}`);
      setJobs(data);
      console.log(data)
    } catch (error) {
    ...
    try {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            const {data } = await axios.delete(`${import.meta.env.VITE_API_URL}/posted-job/delete/${id}`);
            console.log(data)
            ...
            Swal.fire({
              title: "Error!",
              text: "There was an issue deleting your job. Please try again.",
              icon: "error"
            });
